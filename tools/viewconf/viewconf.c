...
##### "LOG_CONF_LEVEL_INT": ____________________ == LOG_CONF_LEVEL_INT
...
##### "INT_CONF_TELEMETRY_EXPERIMENT": _________ == INT_CONF_TELEMETRY_EXPERIMENT

#ifdef INT_CONF_TELEMETRY_EXPERIMENT_SIZE
##### "INT_CONF_TELEMETRY_EXPERIMENT_SIZE": ____ == INT_CONF_TELEMETRY_EXPERIMENT_SIZE
#else
